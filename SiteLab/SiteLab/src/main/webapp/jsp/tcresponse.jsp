    ...
    <body>
        <div class="container">
            ...
            <div class="navbar">
                ...
                <p>Dollar Amount Entered:</p> ${dollarAmount}
                <p>Tip Percentage Entered:</p> ${tipPercentage}
                <p>Tip Amount:</p> ${tipAmount}
                <p>Subtotal:</p> ${subTotal}
                <p>Grand Total:</p> ${grandTotal}
                <br>
                <a href="${pageContext.request.contextPath}/tipcalc">Calculate Again</a>
