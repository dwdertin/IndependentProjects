            ...
            <div>
                <FORM METHOD=POST class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <INPUT TYPE="number" NAME=annualRate value="0">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <INPUT TYPE="number" NAME=initialPrincipal value="0">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-md-3">
                            Enter the number of Year to Invest:
                        </label>
                        <div class="col-md-3">
                            <INPUT TYPE="number" NAME=yearsInvested value="0">
                        <INPUT TYPE=SUBMIT>
                        </div>
