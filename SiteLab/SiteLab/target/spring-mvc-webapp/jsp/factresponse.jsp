...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>Number entered</p> ${numberEnteredByUser}
            <p>Is your number prime?</p> ${isPrime}
            <p>Is your number perfect?</p> ${isPerfect}
            <p>How many factors does it have?</p> ${numberOfFactors}
            <p>What are the factors?</p> ${factorsList}
            <br>
            <br>
            <a href="${pageContext.request.contextPath}/factorizor">Factor Another Number</a>
        </div>
        </div>
